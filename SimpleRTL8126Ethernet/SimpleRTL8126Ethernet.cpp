/* SimpleRTL8126Ethernet.cpp -- RTL8126 driver class implementation.
*
...
OSDefineMetaClassAndStructors(SimpleRTL8126, super)

/* IOService (or its superclass) methods. */

bool SimpleRTL8126::init(OSDictionary *properties)
{
    bool result;
...
bool SimpleRTL8126::start(IOService *provider)
{
    bool result;
...
void SimpleRTL8126::stop(IOService *provider)
{
    UInt32 i;
...
IOReturn SimpleRTL8126::registerWithPolicyMaker(IOService *policyMaker)
{
...
IOReturn SimpleRTL8126::setPowerState(unsigned long powerStateOrdinal, IOService *policyMaker)
{
...
void SimpleRTL8126::systemWillShutdown(IOOptionBits specifier)
{
...
IOReturn SimpleRTL8126::enable(IONetworkInterface *netif)
{
...
IOReturn SimpleRTL8126::disable(IONetworkInterface *netif)
{
    UInt64 timeout;
    UInt64 delay;
    UInt64 now;
...
IOReturn SimpleRTL8126::outputStart(IONetworkInterface *interface, IOOptionBits options )
{
...
void SimpleRTL8126::getPacketBufferConstraints(IOPacketBufferConstraints *constraints) const
{
...
IOOutputQueue* SimpleRTL8126::createOutputQueue()
{
...
const OSString* SimpleRTL8126::newVendorString() const
{
...
const OSString* SimpleRTL8126::newModelString() const
{
...
bool SimpleRTL8126::configureInterface(IONetworkInterface *interface)
{
...
bool SimpleRTL8126::createWorkLoop()
{
...
IOWorkLoop* SimpleRTL8126::getWorkLoop() const
{
...
IOReturn SimpleRTL8126::getHardwareAddress(IOEthernetAddress *addr)
{
    IOReturn result = kIOReturnError;
...
IOReturn SimpleRTL8126::setPromiscuousMode(bool active)
{
...
IOReturn SimpleRTL8126::setMulticastMode(bool active)
{
    UInt32 *filterAddr = (UInt32 *)&multicastFilter;
    UInt32 mcFilter[2];
    UInt32 rxMode;
...
IOReturn SimpleRTL8126::setMulticastList(IOEthernetAddress *addrs, UInt32 count)
{
    UInt32 *filterAddr = (UInt32 *)&multicastFilter;
    UInt64 filter = 0;
    UInt32 i, bitNumber;
...
IOReturn SimpleRTL8126::getChecksumSupport(UInt32 *checksumMask, UInt32 checksumFamily, bool isOutput)
{
...
UInt32 SimpleRTL8126::getFeatures() const
{
...
IOReturn SimpleRTL8126::setWakeOnMagicPacket(bool active)
{
    IOReturn result = kIOReturnUnsupported;
...
IOReturn SimpleRTL8126::getPacketFilters(const OSSymbol *group, UInt32 *filters) const
{
...
IOReturn SimpleRTL8126::setHardwareAddress(const IOEthernetAddress *addr)
{
    IOReturn result = kIOReturnError;
...
IOReturn SimpleRTL8126::selectMedium(const IONetworkMedium *medium)
{
    IOReturn result = kIOReturnSuccess;
...
IOReturn SimpleRTL8126::getMaxPacketSize(UInt32 * maxSize) const
{
...
IOReturn SimpleRTL8126::setMaxPacketSize(UInt32 maxSize)
{
...
void SimpleRTL8126::pciErrorInterrupt()
{
...
void SimpleRTL8126::txInterrupt()
{
    mbuf_t m;
...
UInt32 SimpleRTL8126::rxInterrupt(IONetworkInterface *interface, uint32_t maxCount, IOMbufQueue *pollQueue, void *context)
{
...
void SimpleRTL8126::checkLinkStatus()
{
...
void SimpleRTL8126::interruptHandler(OSObject *client, IOInterruptEventSource *src, int count)
{
    UInt32 packets;
    UInt32 status;
    
    status = ReadReg32(ISR0_8126);
    ...
    WriteReg32(IMR0_8126, 0x0000);
    WriteReg32(ISR0_8126, (status & ~RxFIFOOver));
    ...
    if (!test_bit(__POLL_MODE, &stateFlags) &&
        ...
        if (status & (TxOK | RxOK)) {
            WriteReg32(TIMER_INT0_8126, 0x5000);
            WriteReg32(TCTR0_8126, 0x5000);
            intrMask = intrMaskTimer;
        } else if (status & PCSTimeout) {
            WriteReg32(TIMER_INT0_8126, 0x0000);
    ...
    if (status & LinkChg) {
        checkLinkStatus();
        WriteReg32(TIMER_INT0_8126, 0x000);
        intrMask = intrMaskRxTx;
    }
done:
...
bool SimpleRTL8126::txHangCheck()
{
    bool deadlock = false;
    
    if ((txDescDoneCount == txDescDoneLast) && (txNumFreeDesc < kNumTxDesc)) {
        if (++deadlockWarn == kTxCheckTreshhold) {
            /* Some members of the RTL8126 family seem to be prone to lose transmitter rinterrupts.
            ...
            DebugLog("Warning: Tx timeout, ISR0=0x%x, IMR0=0x%x, polling=%u.\n", ReadReg32(ISR0_8126),
                     ReadReg32(IMR0_8126), test_bit(__POLL_MODE, &stateFlags));
...
IOReturn SimpleRTL8126::setInputPacketPollingEnable(IONetworkInterface *interface, bool enabled)
{
...
void SimpleRTL8126::pollInputPackets(IONetworkInterface *interface, uint32_t maxCount, IOMbufQueue *pollQueue, void *context )
{
...
inline void SimpleRTL8126::getChecksumResult(mbuf_t m, UInt32 status1, UInt32 status2)
{
...
void SimpleRTL8126::setLinkDown()
{
    deadlockWarn = 0;
    needsUpdate = false;
...
void SimpleRTL8126::updateStatitics()
{
...
void SimpleRTL8126::timerActionRTL8126(IOTimerEventSource *timer)
{
#ifdef DEBUG
